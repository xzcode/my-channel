package com.xzcode.product.common.entity.info;
...
public class Info {
	 ...
	 * 行业资讯信息表 表名
	 */
	public static final String __ = "info";
	 ...
	 * 发布管理员
	 */
	public Info setAdminId(Long adminId) {
	 ...
	 * 简介
	 */
	public Info setIntro(String intro) {
		this.intro = intro;
		return this;	
	}
	 ...
	 * 配图
	 */
	public Info setCoverUrl(String coverUrl) {
	 ...
	 * 排序
	 */
	public Info setSort(Integer sort) {
		this.sort = sort;
		return this;	
	}
	 ...
	 * 查看数
	 */
	public Info setReadNum(Integer readNum) {
	 ...
	 * 热门参数
	 */
	public Info setHotNum(Integer hotNum) {
		this.hotNum = hotNum;
		return this;	
	}
	 ...
	 * SEO自定义标题
	 */
	public Info setSeoTitle(String seoTitle) {
	 ...
	 * SEO自定义关键字
	 */
	public Info setSeoKeywords(String seoKeywords) {
	 ...
	 * SEO自定义说明
	 */
	public Info setSeoDescription(String seoDescription) {
	 ...
	 * 启用状态[0 禁用 no; 1 启用 yes]
	 */
	public Info setEnabled(Integer enabled) {
